...
const StatusBoard = ({ tasks, projects, users, onDragEnd, selectedUserId }) => {
    ...
    // Filter tasks based on selectedUserId
    const filteredTasks = selectedUserId
        ? tasks.filter(task => task.assignedTo === selectedUserId)
        : tasks;
                                ...
                                <Droppable droppableId={status}>
                                    {(provided, snapshot) => (
                                        ...
                                        >
                                            ...
                                            {filteredTasks.filter((task) => task.status === status).length === 0 && !snapshot.isDraggingOver && (
                        ...
                        <Grid size={{ xs: 12, md: 9 }}>
                            ...
                            {currentView === 'status' ? (
                                <StatusBoard
                                    ...
                                    users={users}
                                    onDragEnd={onDragEnd}
                                    selectedUserId={selectedUserId} // Pass selected user ID
                                />
                            ) : (
                                <UserBoard
                                    tasks={tasks}
