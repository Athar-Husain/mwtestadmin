...
const Tickets = () => {
            ...
            renderCell: params => (
                <Stack direction="row" spacing={1}>
                    <IconButton
                        color="primary"
                        size="small"
                        onClick={() => navigate(`/ticket/${params.row._id}`)}  // Navigate to the SupportTicketDetail page
                    >
    ...
    return (
        <Box p={4}>
            ...
            <Dialog open={openDialog} onClose={handleCloseDialog} fullWidth maxWidth="sm" aria-labelledby="dialog-title" role="dialog" aria-describedby="dialog-description">
                <DialogTitle id="dialog-title">{dialogType === 'add' ? 'Add New Ticket' : `Edit Ticket`}</DialogTitle>
                <DialogContent>
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                        {/* <Controller
                            ...
                            render={({ field }) => (
                                <Autocomplete
                                    ...
                                    value={connections.find(conn => conn._id === field.value)} // Set selected value
                                    renderInput={(params) => (
                                        <TextField
                                            {...params}
                        ...
                        {[ // Other fields can be added below, just like for connectionId
