...
import BillingDashboard from '../views/Payment/Index';
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: '/dashboard/default', element: <DashboardDefault2 /> },
          { path: '/dashboard2', element: <DashboardDefault3 /> },
          ...
          { path: '/areas/create', element: <RegionForm mode="create" /> },
          ...
          //Connections
          { path: '/connections', element: <AllConnections /> },
